              ...
              <div class="col-md-9">
                ...
                <div class="aa-blog-content aa-blog-details">
                  <article class="aa-blog-content-single">                        
                    <h2>ELIGIBILITY</h2>
                    <ul>  
                    <h3>You should be an account holder of any of the following banks:</h3>
                    <h3>HSBC | SBI | PNB | Kotak | ICICI | HDFC</h3>  
                    <h3>A  minimum balance of Rs.40000/- should be maintained to register for the EMI card</h3>   
                    <h3>The personal documents required should be submitted at the head-office along with the registration fees</h3>
                    <h3></h3>                         
                    </ul>        
                    <h2>Charges</h2>
                    <ul> 
                    <h3>To Register for Gold Card: </h3>
                    <h4>Registration fees : Rs.500/-</h4>
                    <h4 ><a href="CardDetails">Gold Card Details</a></h4>
                    <h3>To Register for Titanium Card: </h3>
                    <h4>Registration fees : Rs.800/-</h4>
                    <h4><a href="CardDetails">Titanium Card Details</a></h4>
                    <ul> 
                      </ul>        
                      <h2>Terms and Conditions:</h2>
                      <ul> 
                      <h3>The person signing up for the EMI-Shop Service is responsible for the account </h3>          
                      <h3>No refund will be provided once the payment is done</h3>             
                      <ul> 
                   </article>
                   </div>
                  </div>
