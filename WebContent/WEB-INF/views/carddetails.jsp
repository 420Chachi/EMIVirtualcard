              ...
              <div class="col-md-9">
                ...
                <div class="aa-blog-content aa-blog-details">
                  <article class="aa-blog-content-single">                        
                    <h2>Gold Card Details</h2>
                    <ul>  
                    <h3>Registration fee: Rs.500/- only</h3>
                    <h3>Creditprovided: Rs.40000/-</h3>  
                    <h3>A  minimum balance of Rs.60000/- should be maintained to register for the EMI card</h3>   
                    <h3>The personal documents required should be submitted at the head-office along with the registration fees</h3>                         
                    </ul>        
                    <h2>Titanium Card Details</h2>
                    <ul>  
                    <h3>Registration fee: Rs.800/- only</h3>
                    <h3>Creditprovided: Rs.80000/-</h3>  
                    <h3>A  minimum balance of Rs.60000/- should be maintained to register for the EMI card</h3>   
                    <h3>The personal documents required should be submitted at the head-office along with the registration fees</h3>                         
                    </ul>                    
                   </article>
