                 ...
                 <div class="container">
                   ...
                   <form action="">                                                  
                     <div class="row">
                         ...
                         <div class="col-75">
                           <input type="text" id="UsernameorEmail" name="UsernameorEmail" placeholder="Username or EmailAddress">
                         </div>
                       </div>                                               
                       <div class="row">
                               <div class="col-25">
                   ...
                   <div class="row">
                      <a href="AdminDashboard" type="submit" class="aa-browse-btn" >Login</a>                       
                   </div>
                   </form>
                 </div>
