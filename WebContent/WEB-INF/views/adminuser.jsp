           ...
           <div class="cart-view-table aa-wishlist-table">
             <form action="">
               <div class="table-responsive">
                  ...
                  <table class="table" id="dataTable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>$250</td>
                        <td>$250</td>
                        <td><a href="#" class="aa-add-to-cart-btn">ACTIVATE</a></td>
                 ...
                 <div class="row">
                      <INPUT type="button" style="text-align: center" class="aa-browse-btn"value="Add Row" />
                      <INPUT type="button" style="text-align: center" class="aa-browse-btn"value="Delete Row"  />
                  </div>
                </div>
             </form>             
           </div>
